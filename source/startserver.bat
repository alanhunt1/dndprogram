...
remset JAVA_EXE=C:\Program Files (x86)\Java\jre6\bin
...
"%JAVA_EXE%\java" -ms64M -mx128M -classpath %CLASSPATH%  -Djava.net.preferIPv4Stack=true initcheck.InitServer UPSTAIRS
