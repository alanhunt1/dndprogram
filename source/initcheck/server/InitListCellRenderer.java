...
public class InitListCellRenderer extends JLabel implements ListCellRenderer {
	static final long serialVersionUID = 1;

	public InitListCellRenderer() {
			...
			boolean cellHasFocus) // the list and the cell have the focus
	{
		...
		setToolTipText("AC:" + p.getPrecalcAc() + " HP: "
				+ p.getCurrentHitPoints() + " STUN:" + (p.getPrecalcHP() / 5));

		String s = p.serverListFormat();
		setText(s);
