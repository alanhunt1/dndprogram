...
public class FileCopy {
		...
		public static void main(String[] args) {
				if (args.length != 2)    // Check arguments 
						...
						// Call copy() to do the copy, and display any 
						// error messages it throws.
		 ...
		 * @param from_name the file to copy
		 * @param to_name the new file name
		 * @throws IOException
		 */
		public static void copy(String from_name, String to_name) 
				throws IOException{
				copy(from_name, to_name, true);
		}
   ...
   * sure everything is as it should be.
	 * @param from_name the file to copy
	 * @param to_name the new file name
	 * @param ask boolean to ask for permission to overwrite
	 * @throws IOException
   */
  public static void copy(String from_name, String to_name, boolean ask) throws IOException{
  ...
  /** A convenience method to throw an exception
	 * @param msg the error message to throw on abort.
	 */
