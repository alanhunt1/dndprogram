...
public class ServicesListCellRenderer extends ToolTipLabel implements ListCellRenderer {

	
	private static final long serialVersionUID = 1L;

	public ServicesListCellRenderer() {
	...
	{
		Services e = (Services) value;
		setToolTipText(e.getFullDescription());
		String s = e.getServiceName()+" "+e.getServiceCost();
		setText(s);
