...
import initcheck.character.chooser.StaffChooser;
...
public class BuildStaffPanel extends GridPanel {
	...
	public void init() {
		...
		ac.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				updateDescription(((Staffs) ac.getSelectedItem())
						.getDescription());
			}
		});
	}
	...
	public void calcCost() {
		...
		Staffs a = (Staffs) ac.getSelectedItem();
