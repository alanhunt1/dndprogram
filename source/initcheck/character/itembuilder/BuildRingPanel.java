...
import initcheck.character.chooser.RingChooser;
...
public class BuildRingPanel extends GridPanel {

	private static final long serialVersionUID = 1L;

	JComboBox<?> ac = new RingChooser();
	...
	public void init() {
		...
		ac.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				updateDescription(((Rings) ac.getSelectedItem())
						.getDescription());
			}
		});
	}
	...
	public void calcCost() {
		...
		Rings a = (Rings) ac.getSelectedItem();
